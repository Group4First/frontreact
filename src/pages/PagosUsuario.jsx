        ...
        <>
          ...
          <section className="flex flex-col items-center relative overflow-x-auto">
            ...
            {pagos.map((pago, index) => (
              <div key={index} className={`xl:h-14 text-vgraydark font-semibold bg-white rounded-xl items-center px-3 mt-5 max-xl:max-w-[280px] max-xl:w-[280px] max-xl:p-5 max-xl:rounded-2xl max-xl:mx-4 xl:grid xl:text-center xl:grid-cols-[1.5fr_1.5fr_1fr_1fr] md::h-14 xl:w-11/12`}>
