                ...
                <div className=" flex flex-wrap centered">
                    <div>
                        ...
                        <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 ml-50 centered-full">
                            <input onChange={(event) => { setTasaanual(event.target.value); }} type="number" placeholder="Digita un numero" className="outline-none text-vgray2 font-semibold w-full text-center" min="2000" max="2099" />
                        </div>
                    </div>
                </div>
                <div className=" flex flex-wrap mt-4 centered">
                    <div>
                        ...
                        <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 centered-full">
                            <select onChange={(event) => { setMes(event.target.value); }} className="outline-none text-vgray2 font-semibold  w-full text-center">
                    ...
                    <div>
                        ...
                        <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 centered-full">
                            <input onChange={({ target }) => setSmmv(target.value)} value={smmv !== "smmv" ? smmv : ""} type="number" placeholder="SMLV" className="outline-none text-vgray2 font-semibold w-full text-center" disabled={condicion} />
                        </div>
                    </div>
                </div>
