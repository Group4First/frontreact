        ...
        <div className="w-full max-w-fu h-svh overflow-y-auto">
            ...
            <section className="w-full flex justify-around flex-wrap mt-8 mb-10 gap-10">
                    <div className="max-w-[350px]">
                        ...
                        <h2 className="text-vgraylight font-medium text-lg mt-4 ">Donec sed erat ut magna suscipit mattis. Aliquam erat volutpat. Morbi in orci risus. Donec pretium f</h2>
                    </div>

                    <div className="flex gap-10">
                        <div className="max-w-52 flex flex-col justify-around h-full">
                            <h1 className="text-vgraylight font-medium text-md"> Fecha inicio: <br/> 05-10-2022</h1>
                            <h1 className="text-vgraylight font-medium text-md"> Fecha fin: <br/> 06-10-2022</h1>
                        </div>
