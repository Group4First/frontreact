                            ...
                            {obras.map((obra, index) => {
                                ...
                                return <div key={index} className="bg-white rounded-lg cursor-pointer"
                                    ...
                                    <div className="w-full flex-col ml-10 mt-7 mb-7">
                                        ...
                                        <h2 className="font-medium text-vgraylight mt-10 text-nowrap">Fecha fin real: {obra.fechafin == null ? 'Sin definir' : obra.fechafin}</h2>
                                        <h2 className="font-medium text-vgraylight mt-6 text-nowrap">Fecha fin aprox: {obra.fechafinaprox}</h2>
