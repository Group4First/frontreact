...
export function Calculo_fic() {
    ...
    const handleCalcular = () => {
        ...
        // Realizar el cálculo basado en el número de empleados
        const costoPorEmpleado = 1300000;
        const numCostoPorEmpleado = Math.ceil(numEmpleados / 40);
        ...
        setResultado(totalCosto);
        
        setResultadoxemp(totalxemp)
    };
                ...
                <div className="sm:w-[600px] md:w-[700px] lg:w-[600px] xl:w-[700px] sm:h-[600px] md:h-[700px] lg:h-[600px] xl:h-[700px] bg-white shadow-xl rounded-2xl flex flex-col justify-center items-center relative">
                    ...
                    <div className="flex flex-col mt-14">
                        <div className="flex items-center mb-2 flex-grow">
                            <div className="h-12 w-36 rounded-l-xl border-2 border-vgray flex items-center font-semibold text-vgray2 px-3 mr-1">
                                <span>Mensual</span>
                            </div>
                            <div className="h-12 w-44 rounded-r-xl border-2 border-vgray flex items-center text-vgray2 px-3">
