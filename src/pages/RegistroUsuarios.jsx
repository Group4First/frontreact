                        ...
                        {!docusuario && (
                            <div>
                                ...
                                <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 centered-full">
                                    <input onChange={(event) => { setDocumento(event.target.value); }} type="text" placeholder="Documento" className="outline-none text-vgray2 font-semibold ml-3 w-[320px] text-center" />
                                </div>
                            </div>
                        )}
                        <div>
                            ...
                            <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 centered-full">
                                <input onChange={(event) => { setNombre(event.target.value); }} value={nombre} type="text" placeholder="Nombre" className="outline-none text-vgray2 font-semibold ml-3 w-[320px] text-center" />
                            </div>
                        </div>
                        <div>
                            <label className="flex flex-wrap mt-3 centered-full justify-center text-center text-black font-semibold">Apellido</label>
                            <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 centered-full">
                                <input onChange={(event) => { setApellido(event.target.value); }} value={apellido} type="text" placeholder="Apellido" className="outline-none text-vgray2 font-semibold ml-3 w-[320px] text-center" />
                            </div>
                        </div>
                        <div className="flex flex-wrap mt-3 centered">
                            <div>
                                ...
                                <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 centered-full">
                                    <input onChange={(event) => { setCorreo(event.target.value); }} value={correo} type="text" placeholder="Correo" className="outline-none text-vgray2 font-semibold ml-3 w-[320px] text-center" />
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div className="bg-white h-12 w-[320px] rounded-xl border-2 border-vgray flex items-center text-vgray2 px-3 mr-4 mt-1 centered-full">
                                    <select onChange={(event) => { setRol(event.target.value); }} value={rol} className="outline-none text-vgray2 font-semibold ml-3 w-[320px] text-center">
